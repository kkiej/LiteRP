...
Light GetDirectionalLight( int index, Surface surfaceWS, ShadowData shadowData)
{
	...
	//light.renderingLayerMask = asuint(_DirectionalLightDirectionsAndMasks[index].w); 使用asuint会失效
...
Light GetOtherLight(int index, Surface surfaceWS, ShadowData shadowData)
{
	...
	//light.renderingLayerMask = asuint(_OtherLightDirectionsAndMasks[index].w); 使用asuint会失效
	light.renderingLayerMask = _OtherLightDirectionsAndMasks[index].w;
	float spotAttenuation = Square(saturate(dot(spotDirection,
		light.direction) * spotAngles.x + spotAngles.y));
