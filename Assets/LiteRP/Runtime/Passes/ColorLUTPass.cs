...
namespace LiteRP.Runtime
{
    ...
    {
        private static readonly ProfilingSampler sampler = new("Color LUT Pass");
        ...
        void Render(RenderGraphContext context)
        {
            ...
            buffer.SetGlobalVector(colorGradingLUTParametersId, new Vector4(lutHeight,
                0.5f / lutWidth, 0.5f / lutHeight, lutHeight / (lutHeight - 1f)));
